...
function getMovieLocations(movieTitle, callBack) {
	//makes an array of locations to be returned by callBack
	var locations = [];
	//mkaes a request for the locations with the movieTitle as a changing parameter
...
app.post('/', (req,res) => {
  //movieTitle is in the front end's JSON object
  var movieTitle = req.body.movieTitle;
  console.log("Movie title is = "+ movieTitle);
  //gets the locations using the film API
